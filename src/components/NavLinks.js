    ...
    return (
        <div className={mobile?'mobile__menu':'menu'}>
            ...
            <span className='menu__link'>
                <NavLink to='/clock'><img alt='' className='icon' src='img/clock.png'  id='clock' onClick={beActive}/></NavLink>
                <br/>{active==='clock'?<i className='material-icons'style={{fontSize:'0.5rem'}}>lens</i>:null}
            </span>
            <span className='menu__link' >
                <NavLink to='/calendar'><img alt='' className='icon' src='img/calendar.png' id='calendar' onClick={beActive}/></NavLink>
